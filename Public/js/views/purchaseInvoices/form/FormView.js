define([
    ...
    'text!templates/purchaseInvoices/form/FormTemplate.html',
    'text!templates/purchaseInvoices/temps/documentTemp.html',
    ...
    var FormView = ParentView.extend({
        ...
        initialize: function (options) {
            ...
            this.currentModel.urlRoot = '/purchaseInvoices';
            this.responseObj = {};
