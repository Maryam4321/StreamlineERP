define([
    ...
    'chai'
], function (JobsCollection, chai) {
    'use strict';
    var expect = chai.expect;

    describe('JobsCollection', function () {
        var mainSpy;
        var server;
        var jobsCollection;
        ...
        var fakeJobs = [
            ...
            project: {
                ...
                salesManagers: [
                    {
                        date: "2014-11-03T12:27:34.493Z",
                        _id: "5707533ecbb17f48214c76cd",
            ...
            payment: {
                ...
                budget: {
                    budgetTotal: {
                        ...
                        maxDate: 201612,
                        hoursByQA: 12,
                        revenueByQA: 0.7750671681891457,
                        hoursSum: 1861,
                        revenueSum: 12020.050000000001,
                        costSum: 8721.51,
                        profitSum: 3298.5200000000004
                    },
                    budget: [
                        {
                            revenue: 516.72,
                        ...
                        },
                        {
                            ...
                            byQA: {
                                hours: 12,
                                revenue: 77.50671681891457
                            }
                        },
                        {
                            revenue: 981.7600000000001,
                            hours: 152,
                            cost: 859.6,
                            profit: 122.16
                        },
                        {
                            revenue: 1918.2700000000002,
                            hours: 297,
                            cost: 499.84999999999997,
                            profit: 1418.42
                        },
                        {
                            revenue: 516.72,
                        ...
                        {
                            revenue: 723.4000000000001,
                            hours: 112,
                            cost: 0,
                            profit: 723.4000000000001
                        },
                        {
                            revenue: 103.35000000000001,
                            hours: 16,
                            cost: 0,
                            profit: 103.35000000000001
                        },
                        {
                            revenue: 775.07,
                            hours: 120,
                        ...
                        {
                            revenue: 310.03000000000003,
                            hours: 48,
                            cost: 0,
                            profit: 310.03000000000003
                        },
                        {
                            revenue: 284.2,
                            hours: 44,
                ...
                wTracks: [
                    "5703c9620bbb61c30355b558",
                    "5703bb6969c37d5903700b76",
                    "57039947e7050b54043a69ad",
                    "57037ab50bbb61c30355b53a",
                    "57037820b50d351f04817c64",
                    "570374cec3a5da3e0347a478",
                    "570374aced3f15af0782f16a",
                    "57036ed769c37d5903700b52",
                    "57036eb0c3a5da3e0347a473",
                    "5702b643b50d351f04817c4f",
                    "5702b6170bbb61c30355b528",
                    "5702b5d3ed3f15af0782f158",
                    "56f394c3e7c600fe4fbae595",
                    "55d19fce8f61e2c90b000022",
                    "55d19f488f61e2c90b00001b",
                    "57037a96e7050b54043a69a0",
                    ...
                    "57037ab5e7050b54043a69a1",
                    "55b92adf21e4b7c40f0010c5",
                    "5703c9cf69c37d5903700b86",
        ...
        it ('Try to create collection', function(done){
            ...
            expect(jobsCollection.toJSON().length).to.be.equals(2);
        });

        it ('Try to create collection without App.projectInfo', function(done){
            var jobsUrl = new RegExp('/jobs/', 'i');
        ...
        it ('Try to create collection with self.bySocket', function(done){
            var spyResponse;
            var jobsUrl = new RegExp('/jobs/', 'i');
            ...
            expect(spyResponse).to.be.have.property('type', 'notify');
            expect(spyResponse).to.be.have.property('message', 'Data were changed, please refresh browser');
        });
        ...
        it ('Try to create collection with error response', function(done){
            ...
            server.respondWith('GET', jobsUrl, [400, {"Content-Type": "application/json"}, JSON.stringify(fakeJobs)]);
            jobsCollection = new JobsCollection({
                viewType: 'list',
                bySocket: true,
                success: function(){
        ...
        it('Try to showMore with error', function(){
            var spyResponse;
            var jobsUrl = new RegExp('/jobs/', 'i');

            server.respondWith('GET', jobsUrl, [400, {"Content-Type": "application/json"}, JSON.stringify(fakeJobs)]);
            jobsCollection.showMore({
                contentType: 'jobs'
            });
            server.respond();
