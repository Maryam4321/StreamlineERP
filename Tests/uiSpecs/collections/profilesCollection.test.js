define([
    ...
    'chai'
], function (ProfilesCollection, chai) {
    'use strict';
    var expect = chai.expect;

    describe('ProfilesCollection', function () {
        var mainSpy;
        var server;
        ...
        it ('Try to create collection', function(){
            ...
            expect(profilesCollection.models).to.be.instanceof(Array);
            expect(profilesCollection.models.length).to.be.equals(9);
        });

        it ('Try to create collection with error', function(){

            server.respondWith('GET', '/profiles/?mid=39', [401, {"Content-Type": "application/json"}, JSON.stringify(new Error())]);
